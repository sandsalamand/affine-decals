...
inline SurfaceData GetDefaultSurfaceData(GeometryOut input)
{
...
inline void DontModifyOutputVertex(inout GeometryOut i)
{
...
#ifndef UPDATE_ATTRIBUTES_TO_VARYINGS

#define UPDATE_ATTRIBUTES_TO_VARYINGS DontModifyAttributesToVaryings

inline void DontModifyAttributesToVaryings(in Attributes attributes, inout GeometryOut varyings)
{
